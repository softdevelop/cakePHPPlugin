...
?>
            <li><?php echo $this->Html->link($type['NodeType']['name'], array('action' => 'add', $type['NodeType']['id']));?></li>
<?php      
        }
    }
    else{
...
//$fieldsets['parent_id'] = $this->Form->input('parent_id', array('type'=>'select', 'label'=>'Leaf', 'options'=>$menus, 'default'=>'--None--', 'escape' => true)); 
